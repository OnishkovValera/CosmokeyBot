...
from bot.routers.customer.subrouters.help_router import help_router
...
customer_router.include_routers(start_router, gift_router, help_router, review_router, info_router)